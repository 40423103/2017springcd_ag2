...
ctx.closePath()
 ...
 40423104：L = 40
 <!-- 以下實際利用  Brython 畫四連桿 trace point 路徑-->
 <canvas id="fourbar_40423104" width="600" height="400"></canvas>
...
ctx.closePath()
 ...
 40423117：L = 35
 <!-- 以下實際利用  Brython 畫四連桿 trace point 路徑-->
 <canvas id="fourbar_40423117" width="600" height="400"></canvas>
...
ctx.closePath()
 ...
 40423136：L = 30
 <!-- 以下實際利用  Brython 畫四連桿 trace point 路徑-->
 <canvas id="fourbar_40423136" width="600" height="400"></canvas>
...
ctx.closePath()
 ...
 40423149：L = 25
 <!-- 以下實際利用  Brython 畫四連桿 trace point 路徑-->
 <canvas id="fourbar_40423149" width="600" height="400"></canvas>
...
ctx.closePath()
 ...
 40423157：L = 25
 <!-- 以下實際利用  Brython 畫四連桿 trace point 路徑-->
 <canvas id="fourbar_40423157" width="600" height="400"></canvas>
